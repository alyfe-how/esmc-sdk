 ...
 *  Injection: f1849719.js + 8e80df94.md PHASE 1
 *
...
// ═══════════════════════════════════════════════════════════════════════
// PRE-FLIGHT CHECK (Called by f1849719.js)
// ═══════════════════════════════════════════════════════════════════════

/**
 * Pre-flight check for f1849719.js injection
...
Examples:
  node 6324b9a0.js tier     # Output: MAX
  node 6324b9a0.js status   # Formatted status display
...
Guardian Protection: Blessing token validated (if available)
    ...
    console.error('   Run: node 6324b9a0.js help');
    process.exit(1);
}

// Export for injection into f1849719.js
module.exports = {
    preFlightCheck,
    validateLicense,
    executeEsmcTier,
