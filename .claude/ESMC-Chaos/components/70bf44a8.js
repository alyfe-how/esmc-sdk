 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 ATHENA Creative CLI */
...
function showUsage() {
    console.log(`
🎖️ ATHENA Creative Synthesizer CLI - Strategic creative intelligence

Usage: node 70bf44a8.js <command> [options]

Commands:
  synthesize <context>     Generate creative solutions
  help                     Show this help

Version: ESMC 3.52 | Module: 7f33e5de.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./7f33e5de.js');
