 ...
 *  Purpose: CLI wrapper for 6da84f2d.js (142KB, 36.5K tokens)
 *  Savings: 36,474 tokens → 500 tokens = 98.6% reduction
 *  Usage: node 94f6784f.js <command> [options]
 */
...
Usage:
  node 94f6784f.js <command> [options]
...
Version: ESMC 3.72 | Module: 6da84f2d.js (142KB)
    `);
}
