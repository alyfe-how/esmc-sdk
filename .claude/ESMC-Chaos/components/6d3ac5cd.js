 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 observability CLI */
...
function showUsage() {
    console.log(`
🎖️ Observability System CLI - System monitoring and observability

Usage: node 6d3ac5cd.js <command> [options]
...
Version: ESMC 3.52 | Module: 91bad867.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./91bad867.js');
