 ...
 *
 * Usage:
 *   node c698dfa7.js generate --operation "seed" --session-outline "{json}" [--silent]
 *
 * Architecture:
...
Usage:
  node c698dfa7.js generate --operation "<name>" --session-outline "<json>" [--silent]
...
Examples:
  node c698dfa7.js generate --operation "seed" --session-outline '{"session_id":"2025-11-13-test"}' --silent
`);
}
