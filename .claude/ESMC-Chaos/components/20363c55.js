 ...
 *  Purpose: CLI wrapper for 3202cbca.js (27KB, 7K tokens)
...
async function main() {
    ...
    if (silent) {
        ...
        console.info = () => {};
        console.warn = () => {};
    } try { if (command === 'help') { showUsage(); return; } const { TimeMachine } = require('./3202cbca.js'); const tm = new TimeMachine(); switch (command) { case 'create': // Restore console for final JSON output
        if (silent) {
