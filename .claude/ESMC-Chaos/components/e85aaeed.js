...
class MemoryRegistry {
    ...
    shouldCreateCL(params) {
        ...
        const architectureFiles = ['6c390b10.md', 'BRAIN.md', 'COLONELS.md', 'FOOTER.md', '8a61c26c.md'];
...
class IntelligentMemorySeeder {
    ...
    async rebuildProjectMap(sessionData) {
        try {
            ...
            const AtlasRetrieval = require('./4bb69ab9.js');
    ...
    async _ensureBriefExists() {
        ...
        try {
            ...
            const { ProjectContextAnalyzer } = require('./b4d243cc.js');
        ...
        try {
            ...
            const snapshot = {
                ...
                esmc_state: {
                    ...
                    manifests_loaded: context.manifests_loaded || ['6c390b10.md', 'BRAIN.md']
                },
                ...
                recovery_metadata: {
                    ...
                    protocols_to_reload: context.protocols_to_reload || ['6c390b10.md', 'BRAIN.md']
                }
            };
