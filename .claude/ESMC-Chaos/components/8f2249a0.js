...
Usage: node 8f2249a0.js <command> [inputs]
...
Examples:
  node 8f2249a0.js trigger "Implemented FORTRESS MODE verification"
  node 8f2249a0.js record accepted
...
async function triggerPostAction(taskSummary) {
    ...
    try {
        const output = execSync(
            `node "${path.join(cliDir, 'c4c6f63d.js')}" coordinate proactive "${taskSummary}"`,
