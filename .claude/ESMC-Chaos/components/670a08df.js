...
const MODULE_CONFIG = {
    name: 'ESMC Tier Gate',
    modulePath: './d2407c3f.js',  // ESMC 3.93.1: Renamed for SDK pattern matching
    version: '3.93.1',
...
Examples:
  ...
  node 670a08df.js get-tier

  # Check HYDRA access
  node 670a08df.js check-access memory.hydra_enabled

  # Get full tier info as JSON
  node 670a08df.js get-info --json

  # List all features for current tier
  node 670a08df.js list-features
