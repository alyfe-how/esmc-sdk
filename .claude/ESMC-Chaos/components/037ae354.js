...
Usage: node 037ae354.js <command> [options] [--silent|-s]
...
function analyzeContextWindow() {
    ...
    const manifests = {
        BOOTSTRAP: fs.existsSync(path.join(claudeDir, 'ESMC Complete/core/8e80df94.md')),
        BRAIN_CORE: fs.existsSync(path.join(claudeDir, 'ESMC Complete/core/0cd9e0a2.md')),
        COLONELS_TALK: fs.existsSync(path.join(claudeDir, 'ESMC Complete/core/a1fa5b4e.md')),
        REFERENCE: fs.existsSync(path.join(claudeDir, 'ESMC Complete/core/48c49efe.md'))
    };
