 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 intelligence-fusion CLI */
...
function showUsage() {
    console.log(`
🎖️ Intelligence Fusion CLI - Fuse multiple intelligence sources

Usage: node 42361d0c.js <command> [options]

Commands:
  fuse <sources>           Fuse intelligence from multiple sources
  help                     Show this help

Version: ESMC 3.52 | Module: intelligence-fusion.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('../intelligence-fusion.js');
