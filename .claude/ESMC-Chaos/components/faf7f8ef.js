 ...
 *
 * Usage:
 *   node faf7f8ef.js show token-budgets
 *   node faf7f8ef.js show philosophy
 *   node faf7f8ef.js show examples <phase>
 *   node faf7f8ef.js show all
 *
 * Architecture:
 ...
 *   "faf7f8ef.js serves documentation as executable logic,
...
const BRAIN_DOCUMENTATION = {
  ...
  token_budgets: {
    ...
    overall: {
      brain_core_read: '~1,735 tokens (0cd9e0a2.md)',
  ...
  execution_flow: {
    ...
    phases: [
      ...
      '  - 2A: eb4c0b81.js (technical feasibility) → feasible check',
      '  - 2B: 5395b3af.js gate (WHERE/WHEN/WHY validation) → PROCEED/DEFER/REJECT',
      '  - 2C: 13c4bee5.js (composite confidence) → FULL/LITE/MINIMAL/SKIP',
...
function main() {
  ...
  if (command !== 'show') {
    console.error(JSON.stringify({
      ...
      usage: 'node faf7f8ef.js show <section>',
