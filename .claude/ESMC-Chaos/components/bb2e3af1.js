 ...
 *  Usage: node bb2e3af1.js load-selective [query] [threshold] [maxSessions] [--silent]
...
class MemoryBundleCLI {
     ...
     */
    loadBundleSelective(query = null, threshold = 0.65, maxSessions = 3) {
        ...
        const bundle = {
            ...
            recent: this.loadRecentMetadata(), // Stage 1: Metadata only
...
Usage:
  node bb2e3af1.js load [query] [--silent|-s]                          Legacy mode: Load ALL sessions
  node bb2e3af1.js load-selective <query> [threshold] [max] [--silent|-s]   Selective mode: Threshold filtering
  node bb2e3af1.js help                                  Show this help
...
Examples:
  node bb2e3af1.js load "memory optimization"
  node bb2e3af1.js load-selective "memory optimization"
  node bb2e3af1.js load-selective "memory optimization" 0.70 5
  node bb2e3af1.js load-selective "token cost threshold" 0.65 3
  node bb2e3af1.js load-selective "PMO test" --silent  (quiet mode)
