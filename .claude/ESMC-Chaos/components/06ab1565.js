 ...
 *
 *  Usage: node 06ab1565.js <system> <command> [options]
 *
 *  Systems:
...
const CLI_MAP = {
    ...
    'aegis': 'f6ea6b55.js',
    'aegis-memory': 'f6ea6b55.js',
    'echelon': '94f6784f.js',
    'echelon-mesh': '94f6784f.js',
    'opus': '3a2a48dd.js',
    'opus-rca': '3a2a48dd.js',
    'atlas': '673f584d.js',
    'atlas-retrieval': '673f584d.js',
    'standards': '22c0f1c8.js',
    'esmc-standards': '22c0f1c8.js',
    'epsilon-athena': '378d473d.js',
    'athena': '378d473d.js',
    'pca': 'de92e764.js',
    'pca-context': 'de92e764.js',
    'cie': '5391f22b.js',
    'context-inference': '5391f22b.js',
    'epsilon': '65c12ba7.js',
    'epsilon-intelligence': '65c12ba7.js',

    // Manifests (20K tokens → 500 = 97.5% savings)
    'manifest': 'bf1914ed.js',
    'brain': 'bf1914ed.js',
    'colonels': 'bf1914ed.js',
    'reference': 'bf1914ed.js',
    'bootstrap': 'bf1914ed.js'
};
...
Usage:
  node 06ab1565.js <system> <command> [options]
...
📋 Manifests:
  ...
  reference [section]            Load 48c49efe.md (18KB → CLI)
  bootstrap                      Load 8e80df94.md
...
Examples:
  node 06ab1565.js aegis seed session-123 "Added auth feature"
  node 06ab1565.js atlas retrieve authentication security
  node 06ab1565.js manifest brain phase1
  node 06ab1565.js echelon orchestrate "implement dark mode"
  node 06ab1565.js opus analyze "deployment failure context"
...
Use: node 06ab1565.js <system> help
    `);
}
