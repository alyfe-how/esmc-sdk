 ...
 *
 *  EXECUTION PROTOCOL:
 *  node d576b54d.js edit <file_path> <old_string> <new_string> [--change="description"]
 *
...
async function handleEdit(args) {
    ...
    if (!filePath || !oldString || !newString) {
        ...
        console.log('\nUsage: node d576b54d.js edit <file_path> <old_string> <new_string> [--change="description"]');
        process.exit(1);
    }
    ...
    const { MemoryRegistry } = require('./be989519.js');
    ...
    if (clDecision.trigger) {
        const { CLAutomation } = require('./e45ca13e.js');
        ...
        clResult = await clAutomation.createCLFile({
            ...
            rationale: `Automated via d576b54d.js`,
...
USAGE:
  node d576b54d.js edit <file_path> <old_string> <new_string> [options]
...
CL TRIGGER CONDITIONS (from shouldCreateCL):
  ALWAYS:
  - Architecture files (8e80df94.md, BRAIN.md, etc.)
...
EXAMPLES:
  # Edit 8e80df94.md (architecture file - CL always created)
  node d576b54d.js edit "./8e80df94.md" "old text" "new text" --change="Fix routing"

  # Edit JavaScript file (CL created if conditions met)
  node d576b54d.js edit "./src/file.js" "foo" "bar" --change="Rename variable"
...
VERSION: ESMC 3.99.0 | Module: d576b54d.js
    `);
}
