 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 license-manager CLI */
...
function showUsage() {
    console.log(`
🎖️ License Manager CLI - Manage ESMC licensing

Usage: node 9197e0e3.js <command> [options]

Commands:
  check                    Check license status
  help                     Show this help

Version: ESMC 3.52 | Module: 3811a2ec.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./3811a2ec.js');
