 ...
 *  Usage: node bf1914ed.js <manifest> [section]
 */
...
const MANIFESTS = {
    ...
    reference: './48c49efe.md',
    bootstrap: './8e80df94.md',
...
Usage:
  node bf1914ed.js <manifest> [section] [options]

Manifests:
  brain                          BRAIN.md (memory retrieval + mesh intelligence)
  colonels                       COLONELS.md (7-colonel deployment)
  reference                      48c49efe.md (ECHO/SEED protocols)
  bootstrap                      8e80df94.md (routing layer)
...
Examples:
  node bf1914ed.js brain          # Load full BRAIN.md
  node bf1914ed.js colonels phase1  # Load Phase 1 of COLONELS
  node bf1914ed.js reference --lines=100  # First 100 lines
