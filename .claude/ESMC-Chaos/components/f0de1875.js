 ...
 *
 * Usage: node f0de1875.js validate --chain <chain-name>
 *
 * Chains:
...
const EXECUTION_CHAINS = {
    ...
    hops: [
      {
        ...
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/bb2e3af1.js',
      ...
      },
      {
        ...
        description: '0cd9e0a2.md references working-memory.json',
        manifest: '0cd9e0a2.md',
    ...
    hops: [
      {
        id: 'piu-analysis',
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/42112527.js',
      ...
      },
      {
        id: 'dki-search',
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/2c423ec8.js',
      ...
      },
      {
        id: 'uip-predict',
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/04dc7167.js',
      ...
      },
      {
        id: 'pca-analyze',
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/de92e764.js',
    ...
    hops: [
      {
        id: 'mesh-fusion',
        type: 'cli-dry-run',
        cli: '.claude/ESMC-Chaos/components/eb4c0b81.js',
        command: 'synthesize',
        requiresInput: true,
      ...
      },
      {
        id: 'esmc-reason-gate',
        type: 'cli-dry-run',
        cli: '.claude/ESMC-Chaos/components/5395b3af.js',
        command: 'gate',
        requiresInput: true,
        skipExecution: true,
        checkOnly: 'file-exists'
      },
      {
        id: 'echelon-decision',
        type: 'cli-dry-run',
        cli: '.claude/ESMC-Chaos/components/13c4bee5.js',
        command: 'synthesize',
        requiresInput: true,
        skipExecution: true,
        checkOnly: 'file-exists'
  ...
  'brain-phase3': {
    ...
    description: '18c97306.js → 5 WAVEs JSON → BRAIN execution',
    hops: [
      {
        id: 'colonels-deployment',
        type: 'cli-execution',
        cli: '.claude/ESMC-Chaos/components/18c97306.js',
        command: 'all',
        expectedOutput: {
          type: 'json',
          schema: {
...
Examples:
  node f0de1875.js validate --chain brain-phase0
  node f0de1875.js validate --chain all
  `);
  process.exit(1);
}
