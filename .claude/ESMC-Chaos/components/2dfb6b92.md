...
**Purpose:** ECHELON-ATHENA dialogue patterns ONLY (execution logic in 8cca72bf.js)
...
**6. Display mission signature with real token usage:**
```
...
- Examples:
  - 47211/200000 = 23.6% (200k plan)
  - 47211/100000 = 47.2% (100k plan)
  - 47211/500000 = 9.4% (500k plan)
...
🎖️  Mission complete | XX.X% | ESMC 4
```
_(Replace XX.X% with actual token usage from system warning)_
...
node ".claude/ESMC-Chaos/components/cace4726.js" generate \
...
**END OF COLONELS-TALK - Execute colonels via 8cca72bf.js**
