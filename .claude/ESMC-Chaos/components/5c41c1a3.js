 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 quality-framework CLI */
...
function showUsage() {
    console.log(`
🎖️ Quality Framework CLI - Code quality assessment and enforcement

Usage: node 5c41c1a3.js <command> [options]

Commands:
  assess <file>            Assess code quality
  enforce                  Enforce quality standards
  help                     Show this help

Version: ESMC 3.52 | Module: b7eb9a9e.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./b7eb9a9e.js');
