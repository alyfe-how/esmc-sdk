 ...
 *  Purpose: CLI wrapper for ecc3819a.js (31KB, 8K tokens)
...
Usage: node 73d59500.js <command> [options]
...
Version: ESMC 3.52 | Module: ecc3819a.js (31KB)
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const { RedTeaming } = require('./ecc3819a.js');
