 ...
 *
 *  Usage:
 *    node 14ab1f6e.js trace --wrong "scribe-session-seed-cli.js" --correct "seed-session.js" --user-message "it should have called seed-session.js"
 *    node 14ab1f6e.js filter --session-id "2025-11-13-esmc-392"
 *    node 14ab1f6e.js list
 */
...
class ATHENAMemoryCorrection {
    ...
    async cmdTrace(args) {
        ...
        if (!wrongInference || !correctAnswer || !userMessage) {
            ...
            console.log('Usage: 14ab1f6e.js trace --wrong "..." --correct "..." --user-message "..."');
            process.exit(1);
        }
    ...
    async cmdTraceInteractive(args) {
        ...
        if (!wrongInference || !correctAnswer || !userMessage) {
            console.error('❌ Error: Missing required arguments');
            console.log('Usage: 14ab1f6e.js trace-interactive --wrong "..." --correct "..." --user-message "..."');
            process.exit(1);
        }
...
Examples:
  node 14ab1f6e.js trace --wrong "scribe-session-seed-cli.js" --correct "seed-session.js" --user-message "it should have called seed-session.js"
  node 14ab1f6e.js trace-interactive --wrong "scribe-session-seed-cli.js" --correct "seed-session.js" --user-message "it should have called seed-session.js"
  node 14ab1f6e.js filter --session-id "2025-11-13-esmc-392"
  node 14ab1f6e.js list
`);
        process.exit(0);
