 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 Dual Intelligence CLI */
...
function showUsage() {
    console.log(`
🎖️ Dual Intelligence Presenter CLI - Present intelligence from multiple sources

Usage: node 21ce8ec2.js <command> [options]

Commands:
  present <context>        Present dual intelligence analysis
  help                     Show this help

Version: ESMC 3.52 | Module: f2d97875.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./f2d97875.js');
