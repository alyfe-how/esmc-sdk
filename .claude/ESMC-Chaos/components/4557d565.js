 ...
 *  Purpose: CLI wrapper for 8c56587c.js (continuous profiling)
...
Usage: node 4557d565.js "<message>" [--silent|-s]
...
Version: ESMC 3.77 | Module: 8c56587c.js
    `);
}
...
async function main() {
    ...
    try {
        ...
        const SignalExtractor = require('./8c56587c.js');
