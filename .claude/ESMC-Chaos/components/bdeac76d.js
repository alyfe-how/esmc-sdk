 ...
 *  Purpose: CLI wrapper for e85aaeed.js (142KB, 36.5K tokens)
 *  Savings: 36,525 tokens → 500 tokens = 98.6% reduction
 *  Usage: node bdeac76d.js <command> [options]
 */
...
Usage:
  node bdeac76d.js <command> [options]
...
Version: ESMC 3.52 | Module: e85aaeed.js (142KB)
    `);
}
...
async function main() {
    ...
    try {
        ...
        const { AEGISSystem } = require('./e85aaeed.js');
