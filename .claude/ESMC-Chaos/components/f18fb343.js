 ...
 *  Savings: 27,123 tokens → 500 tokens = 98.2% reduction
 *  Usage: node f18fb343.js <command> [options]
 */
...
function showUsage() {
    console.log(`
🎖️ OPUS RCA System CLI - Root Cause Analysis for critical failures

Usage:
  node f18fb343.js <command> [options]
