...
const { EchoManager } = require('./03b3a6a8');
...
if (require.main === module) {
    (async () => {
        ...
        console.log(`   MemoryGarbageCollector loaded from 7671f0f8.js`);

        const audit = new AuditLogger();
        console.log(`   AuditLogger loaded from b7ff15ca.js`);
