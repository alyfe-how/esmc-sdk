 ...
 *
 * Usage:
 *   node 18c97306.js WAVE1
 *   node 18c97306.js WAVE2
 *   node 18c97306.js all
 *
 * Architecture:
 ...
 *   "18c97306.js executes specific WAVEs (ALPHA, BETA, etc.) as executable logic,
...
console.log(JSON.stringify({
    ...
    usage: [
      'node 18c97306.js WAVE1           → Execute WAVE 1 (ALPHA)',
      'node 18c97306.js WAVE2           → Execute WAVE 2 (BETA+DELTA+EPSILON)',
      'node 18c97306.js WAVE3           → Execute WAVE 3 (GAMMA)',
      'node 18c97306.js WAVE4           → Execute WAVE 4 (ZETA)',
      'node 18c97306.js WAVE5           → Execute WAVE 5 (ETA)',
      'node 18c97306.js all             → Execute all 5 WAVEs',
      'node 18c97306.js complexity <N>  → Get complexity-based recommendations',
      'node 18c97306.js tier <TIER>     → Check tier availability'
    ],
    examples: [
...
if (command.toLowerCase() === 'all') {
  ...
  if (isNaN(score)) {
    console.log(JSON.stringify({
      ...
      usage: 'node 18c97306.js complexity <0-100>'
    }, null, 2));
    process.exit(1);
  }
  ...
  if (!tier) {
    console.log(JSON.stringify({
      ...
      usage: 'node 18c97306.js tier <FREE|PRO|MAX|VIP>'
    }, null, 2));
    process.exit(1);
  }
