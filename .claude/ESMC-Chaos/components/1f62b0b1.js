 ...
 * Usage: node 1f62b0b1.js audit --scope all
 *
 * Validation Checks:
...
const MANIFEST_FILES = [
  ...
  'REFERENCE-CORE.md', // Deprecated (reverted to 48c49efe.md)
  'BRAIN.md'           // Deprecated
];
...
const MANIFEST_COUNTERS = {
  'Counter_A': '8e80df94.md',
  'Counter_B': '0cd9e0a2.md',
  'Counter_C': 'a1fa5b4e.md',
  'Counter_D': '48c49efe.md',
  'Counter_X': 'bb2e3af1.js'
};
...
function validateFileExists(cliPath) {
  ...
  // Example: ".claude/ESMC-Chaos/components/42112527.js"
...
Usage: node 1f62b0b1.js audit [OPTIONS]

Options:
  --scope <all|core|deprecated>  Validation scope (default: all)

Examples:
  node 1f62b0b1.js audit
  node 1f62b0b1.js audit --scope core
  `);
  process.exit(1);
}
