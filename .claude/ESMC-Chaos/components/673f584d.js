 ...
 *  Purpose: CLI wrapper for 8cacf104.js (78KB, 20.1K tokens)
 *  Savings: 20,173 tokens → 500 tokens = 97.5% reduction
 *  Usage: node 673f584d.js <command> [options]
 */
...
Usage:
  node 673f584d.js <command> [options]
...
Version: ESMC 3.52 | Module: 8cacf104.js (78KB)
    `);
}
...
async function main() {
    ...
    try {
        ...
        const AtlasRetrievalSystem = require('./8cacf104.js');
