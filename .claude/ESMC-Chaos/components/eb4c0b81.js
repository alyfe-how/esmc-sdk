 ...
 *
 * Usage:
 *   node eb4c0b81.js synthesize --piu <json> --dki <json> --uip <json> --pca <json> [--silent]
 *
...
function main() {
  ...
  if (config.command !== 'synthesize') {
    console.error('Usage: eb4c0b81.js synthesize --piu <json> --dki <json> --uip <json> --pca <json> [--silent]');
    process.exit(1);
  }
