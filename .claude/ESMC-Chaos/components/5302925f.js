...
const { PMOGenerator } = require('./5487da3a');
const { PMOLoader } = require('./40070d26');
...
class PMOCLI {
    ...
    async cmdLoad(projectRoot) {
        ...
        try {
            ...
            if (!pmo) {
                ...
                console.log('   Run: node 5302925f.js generate');
                console.log('═══════════════════════════════════════════════════════════════');
                return null;
            }
    ...
    cmdExists(projectRoot) {
        ...
        if (!exists) {
            console.log('\n   Generate PMO: node 5302925f.js generate');
        }
    ...
    async cmdExtract(standardId, format = 'json') {
        ...
        if (!standardId) {
            ...
            console.log('   Usage: node 5302925f.js extract <STANDARD_ID>');
            console.log('   Example: node 5302925f.js extract OWASP');
            console.log('═══════════════════════════════════════════════════════════════');
            return;
        }
    ...
    cmdHelp() {
        ...
        console.log('USAGE:');
        console.log('   node 5302925f.js <command> [options]\n');
        ...
        console.log('   node 5302925f.js generate');
        console.log('   node 5302925f.js load');
        console.log('   node 5302925f.js validate');
        console.log('   node 5302925f.js stats');
        console.log('   node 5302925f.js extract OWASP\n');
