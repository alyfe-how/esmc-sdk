 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 esmc-dashboard CLI */
...
function showUsage() {
    console.log(`
🎖️ ESMC Dashboard CLI - System metrics and monitoring dashboard

Usage: node f193c4d8.js <command> [options]

Commands:
  metrics                  Show system metrics
  help                     Show this help

Version: ESMC 3.52 | Module: 1bdfe5a2.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./1bdfe5a2.js');
