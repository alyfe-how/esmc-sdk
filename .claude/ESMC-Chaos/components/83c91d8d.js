...
class ESMCTimeMachine {
    ...
    async initialize() {
        try {
            ...
            try {
                const MilestoneIntelligence = require('./11f67df9.js');
...
Usage:
  node 83c91d8d.js <command> [arguments]
...
Examples:
  node 83c91d8d.js analyze "implement authentication system"
  node 83c91d8d.js list
  node 83c91d8d.js restore "20250930 1445 Backup FULL Before Auth"
  node 83c91d8d.js cleanup
                `);
        }
    })();
}