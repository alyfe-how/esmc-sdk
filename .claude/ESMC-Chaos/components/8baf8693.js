...
Usage:
  node 8baf8693.js check "<topic>" [--silent]
  node 8baf8693.js load "<topic>" [--silent]
  node 8baf8693.js save "<topic>" '<results_json>' [--silent]
...
Examples:
  node 8baf8693.js check "Implement user authentication"
  node 8baf8693.js load "Fix login bug" --silent
  node 8baf8693.js save "Add dark mode" '{"piu":{...},"dki":{...},...}'
`);
    process.exit(0);
}
