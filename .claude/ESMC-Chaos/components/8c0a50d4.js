 ...
 * ════════════════════════════════════════════════════════════════
 */
/** ESMC 3.101.0 (Silent-by-default) - Base: 3.52 colonel-ops CLI */
...
function showUsage() {
    console.log(`
🎖️ Colonel Operations Tracker CLI - Track colonel deployment operations

Usage: node 8c0a50d4.js <command> [options]

Commands:
  track <operation>        Track colonel operations
  help                     Show this help

Version: ESMC 3.52 | Module: 17048d87.js
    `);
}
...
async function main() {
    ...
    try {
        if (command === 'help' || command === '--help') { if (silent) {
            ...
            showUsage(); return; }
        const Module = require('./17048d87.js');
