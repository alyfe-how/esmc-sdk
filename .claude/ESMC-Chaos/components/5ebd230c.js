...
Usage:
  node 5ebd230c.js <command> [options]
...
Examples:
  5ebd230c.js overview                    # Top 3 priorities (50 tokens)
  5ebd230c.js list --all                  # All 12 files (100 tokens)
  5ebd230c.js get lessons                 # Load lessons file (400 tokens)
  5ebd230c.js get lessons --filter=L002   # Just L002 lesson (50 tokens)
...
function main() {
  try {
    ...
    switch (command) {
      ...
      case 'get':
        if (!type) {
          console.error('❌ Missing type argument. Usage: 5ebd230c.js get <type>');
          process.exit(1);
        }
