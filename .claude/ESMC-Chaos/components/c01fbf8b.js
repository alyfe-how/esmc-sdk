 ...
 *  Purpose: Simplified seed workflow - tells Claude to execute 8a61c26c.md seed protocol
 *  Usage: User types "seed" → 8a61c26c.md routes → Claude builds session → calls seed-session.js
 *
...
When user types "seed", 8a61c26c.md protocol requires:
