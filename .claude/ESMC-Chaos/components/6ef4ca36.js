 ...
 *  Purpose: CLI wrapper for 21c7fb31.js (33KB, 8.5K tokens)
...
Usage: node 6ef4ca36.js <command> [options] [--silent|-s]
...
Version: ESMC 3.77 | Module: 21c7fb31.js (33KB)
    `);
}
...
async function main() {
    ...
    try {
        ...
        const PIUIntentUnderstandingEngine = require('./21c7fb31.js');
