 ...
 *  Purpose: CLI wrapper for 673bb49e.js (27KB, 7K tokens)
...
async function main() {
    ...
    if (silent) {
        ...
        console.info = () => {};
        console.warn = () => {};
    } try { if (command === 'help') { showUsage(); return; } const { MemoryBank } = require('./673bb49e.js'); const bank = new MemoryBank(); switch (command) { case 'store': // Restore console for final JSON output
        if (silent) {
