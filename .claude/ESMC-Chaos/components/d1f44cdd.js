 ...
 *  Purpose: CLI wrapper for 5e361da0.js (23KB, 6K tokens)
...
async function main() {
    ...
    if (silent) {
        ...
        console.info = () => {};
        console.warn = () => {};
    } try { if (command === 'help') { showUsage(); return; } const { Scribe } = require('./5e361da0.js'); const scribe = new Scribe(); switch (command) { case 'write': // Restore console for final JSON output
        if (silent) {
